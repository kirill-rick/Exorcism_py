...
def categorize_dish(dish_name, dish_ingredients):
    ...
    """
    for category_name, category_ingredients in [('VEGAN', VEGAN), ('VEGETARIAN', VEGETARIAN), ('PALEO', PALEO), ('KETO', KETO), ('OMNIVORE', OMNIVORE)]:
...
def tag_special_ingredients(dish):
    ...
    return (dish_name, SPECIAL_INGREDIENTS & set(ingredients))
...
def singleton_ingredients(dishes, intersection):
    ...
    for i, dish in enumerate(dishes):
        for other in dishes[i + 1:]:
            multi |= dish & other
    return all_ingredients - multi - intersection
